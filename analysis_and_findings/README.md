...
For a detailed analysis, please use the [Topic Modeling analysis]([analysis_and_findings/Topic modeling analysis.docx](https://github.com/sayyarahuseynli/thefemaleworkeroftheeast.github.io/blob/main/analysis_and_findings/Topic%20modeling%20analysis.docx)) file. To view it, download the file to your computer. If you have any comments, feel free to email me. 
