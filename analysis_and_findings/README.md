...
Looking at the context in which the word “position” is used in each case, reveals a different circumstance. Often in the first two chapters of every brochure, this term is used to illustrate the oppressiveness of women’s position, using specific examples drawn from traditional practices. Adjectives associated with those practices, such as “barbaric” and “embarrassing”, clearly transmit the judgement of the authors. This finding is one of the many examples of how the ethnographers created narratives justifying the civilizing mission of the Soviet regime, which was aimed at freeing women of the East from their pre-revolutionary misery. 

In some instances, the term “position” describes the status and credibility of local authorities, like religious ulama or traditional healers. In rare instances, the authors highlight a positive pre-revolutionary social position of women, like in Votak brochure shown in Example 3.  The example clearly shows that the social standing of Votak women was not as low as in the neighboring communities. Despite that the authors felt the need to emphasize the prevalent negative aspects of life. The dramatization of the dire conditions pre-revolution and positive ones after are evidentiary of Francine Hirsch’s argument about the state sponsored evolutionism which required eradication of social “backwardness” in the communities thus leveraging the civilizing mission of the state. This mission would not be possible if the position of women were going to only slightly improve.
...
![30 topics analysis](analysis30topics.jpg)
